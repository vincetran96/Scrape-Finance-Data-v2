...
EXAMPLE_BALANCE_SHEET_URL = "https://s.cafef.vn/bao-cao-tai-chinh/VSI/IncSta/2019/4/1/1/ket-qua-hoat-dong-kinh-doanh-cong-ty-co-phan-dau-tu-va-xay-dung-cap-thoat-nuoc.chn"

is_ = {"url": "https://s.cafef.vn/bao-cao-tai-chinh/{0}/IncSta/{1}/{2}/1/1/ket-qua-hoat-dong-kinh-doanh{3}",
        "headers": {
