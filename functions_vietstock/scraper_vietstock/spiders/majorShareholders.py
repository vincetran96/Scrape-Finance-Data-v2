...
from scraper_vietstock.spiders.models.majorshareholders import data as msh
from scraper_vietstock.spiders.models.majorshareholders import name, settings


class majorShareHoldersHandler(scraperVSRedisSpider):
    name = name
