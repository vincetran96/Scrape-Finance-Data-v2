...
from scraper_vietstock.spiders.models.ownerstructure import data as ost
from scraper_vietstock.spiders.models.ownerstructure import (name, settings)
...
class ownerStructureHandler(scraperVSRedisSpider):
    name = name
