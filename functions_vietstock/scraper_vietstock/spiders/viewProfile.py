...
from scraper_vietstock.spiders.models.viewprofile import data as vprf
from scraper_vietstock.spiders.models.viewprofile import (name, settings)
from scraper_vietstock.spiders.scraperVSRedis import scraperVSRedisSpider
from scraper_vietstock.helpers.fileDownloader import save_textfile


class viewProfileHandlder(scraperVSRedisSpider):
    name = name
