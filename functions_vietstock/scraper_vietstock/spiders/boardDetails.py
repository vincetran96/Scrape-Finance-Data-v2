...
from scraper_vietstock.spiders.models.boarddetails import data as bd
from scraper_vietstock.spiders.models.boarddetails import (name, settings)
...
class boardDetailsHandler(scraperVSRedisSpider):
    name = name
